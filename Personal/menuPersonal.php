        ...
        <div class="doc-wrapper">
            <div class="container">
                <div id="doc-header" class="doc-header text-center">
                    <h1 class="doc-title"><span aria-hidden="true" class="icon fa fa-users"></span> Personal</h1>
                </div><!--//doc-header-->
                ...
                <div id="cards-wrapper" class="cards-wrapper row">
                    ...
                    <div class="item item-green col-lg-4 col-6">
                        <div class="item-inner">
                            ...
                            <a class="link" href="verTrabajadores.php"><span></span></a>
                        </div><!--//item-inner-->
                    </div><!--//item-->
                    <div class="item item-primary col-lg-4 col-6">
                        <div class="item-inner">
                            ...
                            <a class="link" href="formTrabajador.php"><span></span></a>
                        </div><!--//item-inner-->
                    </div><!--//item-->
                    <div class="item item-pink item-2 col-lg-4 col-6">
                        <div class="item-inner">
                            <div class="icon-holder">
                                <span aria-hidden="true" class="icon fa fa-calendar"></span>
                            </div><!--//icon-holder-->
                    ...
                    <div class="item item-blue col-lg-4 col-6">
                        <div class="item-inner">
                            <div class="icon-holder">
                                <span aria-hidden="true" class="icon fa fa-arrow-up"></span>
                                 <span aria-hidden="true" class="icon fa fa-arrow-down"></span>
                            </div><!--//icon-holder-->
                    ...
                    <div class="item item-purple col-lg-4 col-6">
                        <div class="item-inner">
                            ...
                            <p class="intro">Control de los Permisos</p>
