                        ...
                        <div class="content-inner">
                            <section id="dashboards" class="doc-section">
                                <div class="section-block">
                                    <div>
                                    <table class="table  table-inverse table-hover col-12>" >
                                        <thead align="center">
                                            <tr>
                                                <th>Nombre</th>
                                                <th>Apellido</th>
                                        ...
                                        <tbody align="center">
                                            <tr >
                                                ...
                                                <td>12643458P</td>
                                                <td>12/12/1972</td>
                                                <td><span style="font-size: 20px" class="fas fa-address-card" contextmenu="Editar"></span></td>
                                                <td><span style="font-size: 20px" class="fas fa-user-edit" contextmenu="Editar"></span></td>
                                                <td><span style="font-size: 20px" class="icon fas fa-user-times"></span></td>
                                            </tr>
                                             <tr>
                                                <td>Julian</td>
                                                <td>Martine</td>
                                                ...
                                                <td><span style="font-size: 20px" class="fas fa-address-card" contextmenu="Editar"></span></td>
                                               <td><span style="font-size: 20px" class="fas fa-user-edit" contextmenu="Editar"></span></td>
                                                <td><span style="font-size: 20px" class="icon fas fa-user-times"></span></td>                 </tr>
                                            <tr>
                                                <td>Maria</td>
                                                <td>asdasfa</td>
                                                <td>12343458P</td>
