        ...
        <header id="header" class="header">
            <div class="container">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="../verTrabajadores.php">Trabajadores</a></li>
                    <li class="breadcrumb-item active">Editar Trabajador</a></li>
                </ol>
            </div><!--//container-->
        </header><!--//header-->
                        ...
                        <div class="content-inner">
                            <section id="dashboards" class="doc-section">
                                <div class="section-block">
                                    <form name="edit" method="POST" action="editTrabajadorBD.php">
                                        <?php
                                            ...
                                            <div class="form-group row justify-content-md-center">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="apellidos" value="<?php echo $linea['apellido'] ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row justify-content-md-center">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="dni" value="<?php echo $linea['dni'] ?>" >
                                                </div>
                                            </div>
                                            <div class="form-group row justify-content-md-center">
                                                ...
                                                <div class="col-sm-10">
                                                    <select class="custom-select" name="puesto">
                                                        ...
                                                        <?php
                                                            ...
                                                            $sqlPuesto = "SELECT * FROM puestos";

                                                             $registrosPuesto=mysqli_query($conexion,$sqlPuesto);

                                                             while ($lineaPuesto=mysqli_fetch_array($registrosPuesto)) {

                                                                if ($linea['idPuesto'] != $lineaPuesto['idPuesto']) {
                                                                    echo "
                                                                    <option value='$lineaPuesto[idPuesto]'>$lineaPuesto[puesto]</option>";
                                                                }else{
                                                                    echo "<option value='$lineaPuesto[idPuesto]' selected>$lineaPuesto[puesto]</option>";
                                                                }
                                                             }
                                                         ?>
                                                    </select>
                                            ...
                                            <div class="form-group row justify-content-md-center">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="date" class="form-control" id="date"  name="fecNac" value="<?php echo $linea['fecNac'] ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row justify-content-md-center">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control"  name="pass" value="<?php echo $linea['password'] ?>">
                                                </div>
                                            </div>
                                            <div class="form-group row justify-content-md-center">
                                                <label  class="col-sm-2 form-control-label">Curriculum</label>
                                                <div class="col-sm-10">
                                                    <input type="file" id="file" name="curriculum"  value="<?php echo $linea['curriculum'] ?>" />
                                            ...
                                            <div class="form-group row justify-content-md-center">
                                                ...
                                                <div class="col-sm-10">
                                                     <input type="file" id="file" name="contrato"   value="<?php echo $linea['contrato'] ?>" />
                                                    <span class="file-custom"></span>
                                                </div>
                                            </div>
                                            <div class="form-group row justify-content-md-center">
