        ...
        <div class="doc-wrapper">
            <div class="container">
                <div id="doc-header" class="doc-header text-center">
                    ...
                    <input class="btn btn-info" type="button" value="Solicitar Vacaciones">
                </div><!--//doc-header-->
                                    ...
                                    <table class="table  table-inverse table-hover col-12>" >
                                        ...
                                        <tbody align="center">
                                            <tr >
                                                ...
                                                <td>10/09/19</td>
                                                <td>25/09/19</td>
                                                <td><span style="font-size: 20px" class="fas fa-calendar-plus" contextmenu="Editar"></span></td>
                                                <td><span style="font-size: 20px" class="icon fas fa-calendar-times"></span></td>
                                            </tr>
                                             <tr>
                                                <td>Pedro</td>
                                                <td>Morales</td>
