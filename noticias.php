        ...
        <div class="doc-wrapper">
            <div class="container">
                <div id="doc-header" class="doc-header text-center">
                    <h1 class="doc-title"><span aria-hidden="true" class="icon fa fa-newspaper"></span> Noticias</h1>
                </div><!--//doc-header-->
                ...
                <div id="cards-wrapper" class="cards-wrapper row">
                    <div class="item  col-lg-4 col-6">
                        <div class="item-inner">
                            ...
                            <p class="intro">Subcabecera</p>
                            <a class="link" href="Noticias/leerNoticia.html"><span></span></a>
                        </div><!--//item-inner-->
                    </div><!--//item-->
                    <div class="item  item-2 col-lg-4 col-6">
                        <div class="item-inner">
